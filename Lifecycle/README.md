# React 中的 生命周期（Lifecycle） 版本（16.12.0）高于16.4

react 的生命周期，再引入 Fiber 之后，react的生命周期也有所变化，新增了一些生命周期函数，同时也建议使用者废弃一些生命周期函数，下面先对比一下react v16.3之前的生命周期与react v16.4及之后的生命周期函数。
...
### 1.2 react v16.4开始的版本，可查看 [react生命周期图谱](http://projects.wojtekmaj.pl/react-lifecycle-methods-diagram/)
